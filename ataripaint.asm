...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        lda SkipGameFlag
        beq GameTitleScreenStart
        jmp PlaySwatterGame
GameTitleScreenStart
        lda #FLY_GAME_TITLE_BG_COLOR
        sta COLUBK
        ldy #0
GameTitleScreenTopBuffer
        inx
        cpx #FLY_GAME_TITLE_VPOS
        sta WSYNC
        bne GameTitleScreenTopBuffer
...
GameTitleLine1
        ...
        sta PF1
        sta PF2
GameTitleMiddleBuffer
        inx
        ldy #0
        cpx #FLY_GAME_TITLE_VPOS+27
        sta WSYNC
        bne GameTitleMiddleBuffer
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
GameTitleBottomBuffer
        inx
        cpx #135
        sta WSYNC
        bne GameTitleBottomBuffer
        SLEEP 2

;;;;;;;;;;;;;;;;;;;;;; Game Select ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
GameNumPlayersSelectLine1 
        txa                                             ; 2
        sec
        sbc #135                                        ; 2
        tay                                             ; 2
        ...
        cpx #140
        sta WSYNC
        bne GameNumPlayersSelectLine1

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
GameNumPlayersSelectMiddleBuffer
        inx
        cpx #145
        sta WSYNC
        bne GameNumPlayersSelectMiddleBuffer

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
GameNumPlayersSelectLine2 
        txa                                             ; 2
        sec
        sbc #145                                        ; 2
        tay                                             ; 2 
        ...
        cpx #150
        sta WSYNC
        bne GameNumPlayersSelectLine2
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

GameTitleScreenBottomBuffer
        inx
        cpx #192
        sta WSYNC
        bne GameTitleScreenBottomBuffer
...
TextBuilder
        ...
        lda #>Space
        sta Game2SelectionGfx+1
SkipSelectGame1Player

        ldy SWCHA
        cpy #%11011111
        bne SkipSelectGame2Player
        ldy #1
        sty GameSelectFlag
...
ScoreArea 
        ...
        cpx #15                                          ; 2     See if we're at line 16
...
ScoreAreaBuffer
        ...
        cpx #32
        sta WSYNC
        bne ScoreAreaBuffer                          ; 2/3

GameBoard
;;;;;;;;;;;;;;;; Drawing Players ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

        cpx Player0YPos
        bne SkipSetDrawP0Flag
        lda #1
        sta DrawP0Sprite
SkipSetDrawP0Flag

        cpx Enemy0YPos
        bne SkipSetDrawE0Flag
        lda #1
        sta DrawE0Sprite
SkipSetDrawE0Flag

        cpx Enemy1YPos
        bne SkipSetDrawE1Flag
        lda #1
        sta DrawE1Sprite
SkipSetDrawE1Flag

;         cpx Enemy2YPos
;         bne SkipSetDrawE2Flag
;         lda #1
;         sta DrawE2Sprite
; SkipSetDrawE2Flag
        lda Fire
