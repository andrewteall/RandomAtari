...
P0Height   .byte  #28
; Song       .byte  #60,#3,#1,#7,#60,#3,#2,#7,#60,#3,#3,#7,#60,#3,#4,#7,#60,#3,#5,#7,#60,#3,#6,#7,#60,#3,#7,#7,#60,#3,#8,#7,#60,#3,#9,#7,#255,#3,#10,#5
Song       .byte  #60,#3,#5,#7,#60,#3,#6,#7,#60,#3,#7,#7,#60,#3,#6,#7,#60,#3,#5,#7,#60,#3,#5,#7,#60,#3,#5,#7,#60,#3,#6,#7,#60,#3,#6,#7,#60,#3,#6,#7,#60,#3,#5,#7,#60,#3,#3,#7,#60,#3,#3,#7,#255,#3,#10,#5
